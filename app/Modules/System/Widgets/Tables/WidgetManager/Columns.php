...
namespace Modules\System\Widgets\Tables\WidgetManager;
...
");
    ...
    protected function columnWidgets()
    {
        $preview = new Column('widgets');
        $preview->setTitle(T::_('widgets'));
        $preview->setClassName('dt-center');
        $preview->setWidth('5px');
        $preview->setRender( /** @lang JavaScript */
            "
return '<a href=\"'+row.slug+'\"><i class=\"fas fa-puzzle-piece\"></i></a>';
");
        $this->addColumn($preview);
    }
...
");
    ...
    protected function buttonCreate()
    {
        ...
        $create->setEditor( $this->getEditor( 'widget_manager_editor' ) );
    ...
    protected function buttonEdit()
    {
        ...
        $edit->setEditor( $this->getEditor( 'widget_manager_editor' ) );
        $this->addButton( $edit );
    }
    ...
    protected function buttonRemove()
    {
        ...
        $remove->setEditor( $this->getEditor( 'widget_manager_editor' ) );
