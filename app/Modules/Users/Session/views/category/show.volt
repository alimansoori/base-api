            ...
            buttons: [
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        window.location.href = '{{ url.get('session/manage/add') }}';
                        return false;
                    }
                },
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        ...
                        window.location.href = '{{ url.get('session/manage/edit/') }}'+id;
                        return false;
                    }
                },
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        var id = dt.row( { selected: true } ).data().id;
                        window.location.href = '{{ url.get('session/manage/delete/') }}'+id;
                        return false;
                    }
                }
            ]
