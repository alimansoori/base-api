...
/**
 * Summary Class ManageController
 *
 * Description Class ManageController
 *
 * @author Ali Mansoori
 * @copyright Copyright (c) 2017-2018, ILYA-IDEA Company
...
class CategoryController extends ControllerBase
{
    ...
    {
        die( 'ManageController' );
    }

    public function showAction ()
    {
        $this->content->setTemplate("manage");
        ...
        try
        {
            if ( $this->request->isPost() && $categoryForm->isValid( $this->request->getPost() ) )
            {
                ...
                if ( $categoryModel->save() )
                {
                    ...
                    $this->response->redirect( 'session/manage/show' );
                } else
                {
