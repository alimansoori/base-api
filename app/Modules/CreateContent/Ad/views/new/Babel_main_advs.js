...
var IlyaMenuMulti =
  /*#__PURE__*/
  (function(_IlyaMenu) {
    _inherits(IlyaMenuMulti, _IlyaMenu);

    function IlyaMenuMulti(name, root) {
      ...
      _classCallCheck(this, IlyaMenuMulti);

      typeof data == 'string'
        ? ((_temp = _this2 = _possibleConstructorReturn(
            this,
            _getPrototypeOf(IlyaMenuMulti).call(this, name, root, null, initId)
          )),
          _defineProperty(
        ...
        : ((_temp2 = _this2 = _possibleConstructorReturn(
            this,
            _getPrototypeOf(IlyaMenuMulti).call(this, name, root, data, initId)
          )),
          (_temp = _this2 = _possibleConstructorReturn(
            this,
            _getPrototypeOf(IlyaMenuMulti).call(this, name, root, null, initId)
          ...
          _temp,
          _temp2);
      _this2.typeClass = 'ilya-menu-multi';
      ...
      if (typeof data == 'string') {
        ...
        getAjax(data)
          .then(function(files) {
            _this2.data = files.map(function(item) {
              return {
                ...item
              };
            });
    ...
    return IlyaMenuMulti;
  })(IlyaMenu);

// var Widget1Menu = new IlyaMenuMulti('widget-1', '#ilya-sidebar__fixed', link1);
//
// Widget1Menu.onChange = function() {
//   var id = Widget1Menu.getId(); // console.log(id);
//   // menu.data = input;
//
