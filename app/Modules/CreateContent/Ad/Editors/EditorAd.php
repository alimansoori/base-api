...
//        $this->addFieldParent();
    ...
    public function initAjax(): void
    {
        $this->ajaxCreate->setUrl(
            $this->url->get([
                'for' => 'api_create_ad__'. ModelLanguage::getCurrentLanguage()
            ])
        );
        ...
        $this->ajaxRemove->setUrl(
            $this->url->get([
                'for' => 'api_remove_ad__'. ModelLanguage::getCurrentLanguage()
            ])
        );
    }
...
//        $this->fieldCategoryId();
    ...
    private function fieldCategoryId()
    {
